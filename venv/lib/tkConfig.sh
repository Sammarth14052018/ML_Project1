...
# installed.
TK_PREFIX='/home/sam/Documents/Project Udemy/ml_project_1/venv'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/home/sam/Documents/Project Udemy/ml_project_1/venv'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/home/sam/Documents/Project Udemy/ml_project_1/venv/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/home/sam/Documents/Project Udemy/ml_project_1/venv/include'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/home/sam/Documents/Project Udemy/ml_project_1/venv/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/croot/tk_1755243777296/work/tk8.6.15/unix/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/home/sam/Documents/Project Udemy/ml_project_1/venv/lib/libtkstub8.6.a'
